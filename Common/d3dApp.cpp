...
// Force NVidia usage on an Optimus configured laptop (must be in Auto-select mode)
extern "C" {
...
bool D3DApp::InitDirect3D()
{
	...
	if( FAILED(hr) )
	{
		MessageBox(MainWnd(), L"D3D11CreateDevice Failed.", 0, 0);
		return false;
	}

	if( featureLevel != D3D_FEATURE_LEVEL_11_0 )
	{
		MessageBox(MainWnd(), L"Direct3D Feature Level 11 unsupported.", 0, 0);
		//return false;
	}
